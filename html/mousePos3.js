...
let expName = 'mousePos3';  // from the Builder filename that created this script
...
var endComponents;
function endRoutineBegin(trials2) {
  return function () {
...
function endRoutineEachFrame(trials2) {
  return function () {
...
function endRoutineEnd(trials2) {
  return function () {
    //------Ending Routine 'end'-------
    for (const thisComponent of endComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
  ...
  return function () {
    if (typeof loop !== 'undefined') {
      ...
      thisScheduler.stop();
        ...
        if (typeof thisTrial2 === 'undefined' || !('isTrials2' in thisTrial2) || thisTrial.isTrials2) {
          psychoJS.experiment.nextEntry(loop);
        }
      }
    return Scheduler.Event.NEXT;
