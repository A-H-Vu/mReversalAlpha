...
expName = 'mousePos3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\mousePosTest3\\mousePos3_lastrun.py',
...
instr1 = visual.TextStim(win=win, name='instr1',
    text='Use your mouse to move the cursor between the middle start position and the outward targets.\n\nAlways try to move as straight and smooth as possible. Once you settle into your pace, do not slow down: whenever you make an error, just do better on the next trial. Pace is key. (FOR TEST BUILD ONLY: space to skip trials).\n\nPress SPACE to start!',
    font='Arial',
...
instr2 = visual.TextStim(win=win, name='instr2',
    text='Next trials coming. The cursor movement will be flipped over the y-axis. (FOR TEST BUILD ONLY: space to skip trials).\n\nPress space to continue.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
instr3 = visual.TextStim(win=win, name='instr3',
    text='Next trials coming. The cursor movement will be normal. (FOR TEST BUILD ONLY: space to skip trials).\n\nPress space to continue.',
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
trials1 = data.TrialHandler(nReps=15, method='sequential', 
...
# completed 15 repeats of 'trials1'
...
# set up handler to look after randomisation of conditions etc
trials3 = data.TrialHandler(nReps=15, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 15 repeats of 'trials3'
